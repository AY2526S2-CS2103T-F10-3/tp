...
/**
 * Parses input arguments and creates a new UpdateAttendanceCommand object.
 */
public class UpdateAttendanceCommandParser implements Parser<UpdateAttendanceCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the EditCommand
     * and returns an EditCommand object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public UpdateAttendanceCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        try {
            ...
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                            UpdateAttendanceCommand.MESSAGE_USAGE), pe);
        }
        ...
        */
        ...
        return new UpdateAttendanceCommand(index, weekNumber, status);
    }
}
